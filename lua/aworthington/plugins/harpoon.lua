return {
  ...
  keys = function()
    ...
    return {
      ...
      {"<c-j>", function() harpoon:list():select(2) end, desc ="Harpoon buffer 2"},
      {"<c-k>", function() harpoon:list():select(3) end, desc ="Harpoon buffer 3"},
      {"<c-l>", function() harpoon:list():select(4) end, desc ="Harpoon buffer 4"},
      ...
      {"<c-t>", function() toggle_telescope(harpoon:list() )end, desc ="Open Harpoon window"},
    }
  end,
